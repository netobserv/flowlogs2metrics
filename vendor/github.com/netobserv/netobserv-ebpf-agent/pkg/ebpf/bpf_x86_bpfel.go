...
type BpfMapSpecs struct {
	...
	SkBuffsEgressMap      *ebpf.MapSpec `ebpf:"sk_buffs_egress_map"`
	SkBuffsIngressMap     *ebpf.MapSpec `ebpf:"sk_buffs_ingress_map"`
}
...
type BpfMaps struct {
	...
	SkBuffsEgressMap      *ebpf.Map `ebpf:"sk_buffs_egress_map"`
	SkBuffsIngressMap     *ebpf.Map `ebpf:"sk_buffs_ingress_map"`
}
